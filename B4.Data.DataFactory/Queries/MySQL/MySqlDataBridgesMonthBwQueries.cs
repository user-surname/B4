...
{
    public sealed class MySqlDataBridgesMonthBwQueries : IDataBridgesMonthBwQueries
    {
        ...
        public string GetByIdQuery() => "SELECT * FROM DATA_BridgesMonth_BW WHERE id = @Id";

        public string GetAllQuery() => "SELECT * FROM DATA_BridgesMonth_BW";

        public string UpdateQuery() => @"
            UPDATE DATA_BridgesMonth_BW SET
        ...
        public string DeleteQuery() => "DELETE FROM DATA_BridgesMonth_BW WHERE id = @Id";

        public string GetByPlantaEjercicioQuery() => @"
            SELECT * FROM DATA_BridgesMonth_BW
