...
{
    public sealed class MySqlDataBudgetBwQueries : IDataBudgetBwQueries
    {
        ...
        public string GetByIdQuery() => "SELECT * FROM DATA_Budget_BW WHERE id = @Id";

        public string GetAllQuery() => "SELECT * FROM DATA_Budget_BW";

        public string UpdateQuery() => @"
            UPDATE DATA_Budget_BW SET
        ...
        public string DeleteQuery() => "DELETE FROM DATA_Budget_BW WHERE id = @Id";

        public string GetByPlantaEjercicioQuery() => @"
            SELECT * FROM DATA_Budget_BW
