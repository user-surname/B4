...
{
    public sealed class MySqlDataBudgetQueries : IDataBudgetQueries
    {
        ...
        public string GetByIdQuery() => "SELECT * FROM DATA_Budget WHERE id = @Id";

        public string GetAllQuery() => "SELECT * FROM DATA_Budget";

        public string UpdateQuery() => @"
            UPDATE DATA_Budget SET
        ...
        public string DeleteQuery() => "DELETE FROM DATA_Budget WHERE id = @Id";
