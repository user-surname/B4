...
{
    public sealed class MySqlDataForecastBwQueries : IDataForecastBwQueries
    {
        ...
        public string GetByIdQuery() => "SELECT * FROM DATA_Forecast_BW WHERE id = @Id";

        public string GetAllQuery() => "SELECT * FROM DATA_Forecast_BW";

        public string UpdateQuery() => @"
            UPDATE DATA_Forecast_BW SET
        ...
        public string DeleteQuery() => "DELETE FROM DATA_Forecast_BW WHERE id = @Id";

        public string GetByPlantaEjercicioQuery() => @"
            SELECT * FROM DATA_Forecast_BW
