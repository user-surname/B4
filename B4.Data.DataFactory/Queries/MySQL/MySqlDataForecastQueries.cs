...
{
    public sealed class MySqlDataForecastQueries : IDataForecastQueries
    {
        ...
        public string GetByIdQuery() => "SELECT * FROM DATA_Forecast WHERE id = @Id";

        public string GetAllQuery() => "SELECT * FROM DATA_Forecast";
        ...
        public string DeleteQuery() => "DELETE FROM DATA_Forecast WHERE id = @Id";

        public string GetByPlantaEjercicioQuery() => @"
            SELECT * FROM DATA_Forecast
