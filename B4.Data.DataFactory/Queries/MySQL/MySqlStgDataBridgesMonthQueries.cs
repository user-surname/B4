...
{
    public sealed class MySqlStgDataBridgesMonthQueries : IStgDataBridgesMonthQueries
    {
        ...
        public string GetByIdQuery() => "SELECT * FROM STG_DATA_BridgesMonth WHERE id = @Id";

        public string GetAllQuery() => "SELECT * FROM STG_DATA_BridgesMonth";

        public string UpdateQuery() => @"
            UPDATE STG_DATA_BridgesMonth SET
        ...
        public string DeleteQuery() => "DELETE FROM STG_DATA_BridgesMonth WHERE id = @Id";

        public string GetByPlantaEjercicioQuery() => @"
            SELECT * FROM STG_DATA_BridgesMonth
