...
{
    public sealed class MySqlStgDataForecastQueries : IStgDataForecastQueries
    {
        ...
        public string GetByIdQuery() => "SELECT * FROM STG_DATA_Forecast WHERE id = @Id";

        public string GetAllQuery() => "SELECT * FROM STG_DATA_Forecast";

        public string UpdateQuery() => @"
            UPDATE STG_DATA_Forecast SET
        ...
        public string DeleteQuery() => "DELETE FROM STG_DATA_Forecast WHERE id = @Id";

        public string GetByPlantaEjercicioQuery() => @"
            SELECT * FROM STG_DATA_Forecast
