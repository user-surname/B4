...
{
    public sealed class PostgreSqlDataBridgesMonthQueries : IDataBridgesMonthQueries
    {
        ...
        public string GetByIdQuery() => "SELECT * FROM b4.data_bridges_month WHERE id = @Id";

        public string GetAllQuery() => "SELECT * FROM b4.data_bridges_month LIMIT 2000";
        ...
        public string DeleteQuery() => "DELETE FROM b4.data_bridges_month WHERE id = @Id";

        public string GetByPlantaEjercicioQuery() => @"
            SELECT * FROM b4.data_bridges_month
