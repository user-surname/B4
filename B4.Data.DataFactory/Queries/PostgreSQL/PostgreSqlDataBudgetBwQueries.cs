...
{
    public sealed class PostgreSqlDataBudgetBwQueries : IDataBudgetBwQueries
    {
        public string AddQuery() => @"
            INSERT INTO b4.data_budget_bw
        ...
        public string GetByIdQuery() => "SELECT * FROM b4.data_budget_bw WHERE id = @Id";

        public string GetAllQuery() => "SELECT * FROM b4.data_budget_bw LIMIT 2000";

        public string UpdateQuery() => @"
            UPDATE b4.data_budget_bw SET
        ...
        public string DeleteQuery() => "DELETE FROM b4.data_budget_bw WHERE id = @Id";

        public string GetByPlantaEjercicioQuery() => @"
            SELECT * FROM b4.data_budget_bw
