...
{
    public sealed class PostgreSqlDataBudgetQueries : IDataBudgetQueries
    {
        public string AddQuery() => @"
            INSERT INTO b4.data_budget
        ...
        public string GetByIdQuery() => "SELECT * FROM b4.data_budget WHERE id = @Id";

        public string GetAllQuery() => "SELECT * FROM b4.data_budget LIMIT 2000";

        public string UpdateQuery() => @"
            UPDATE b4.data_budget SET
        ...
        public string DeleteQuery() => "DELETE FROM b4.data_budget WHERE id = @Id";

        public string GetByPlantaEjercicioQuery() => @"
            SELECT * FROM b4.data_budget
