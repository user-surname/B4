...
{
    public sealed class PostgreSqlDataForecastQueries : IDataForecastQueries
    {
        public string AddQuery() => @"
            INSERT INTO b4.data_forecast
        ...
        public string GetByIdQuery() => "SELECT * FROM b4.data_forecast WHERE id = @Id";

        public string GetAllQuery() => "SELECT * FROM b4.data_forecast LIMIT 2000";

        public string UpdateQuery() => @"
            UPDATE b4.data_forecast SET
        ...
        public string DeleteQuery() => "DELETE FROM b4.data_forecast WHERE id = @Id";

        public string GetByPlantaEjercicioQuery() => @"
            SELECT * FROM b4.data_forecast
