...
namespace B4.Data.DataFactory.Queries.PostgreSQL
{
    ...
    /// </summary>
    public sealed class PostgreSqlStgDataActualsQueries : IStgDataActualsQueries
    {
        /// <summary>
        ...
        {
            return @"
                INSERT INTO b4.stg_data_actuals
        ...
        {
            return "SELECT * FROM b4.stg_data_actuals WHERE id = @Id";
        }
        ...
        {
            return "SELECT * FROM b4.stg_data_actuals LIMIT 2000";
        }
        ...
        {
            return @"
                UPDATE b4.stg_data_actuals SET
        ...
        {
            return "DELETE FROM b4.stg_data_actuals WHERE id = @Id";
        }
