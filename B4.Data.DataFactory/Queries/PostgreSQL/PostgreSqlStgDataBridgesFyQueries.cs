...
{
    public sealed class PostgreSqlStgDataBridgesFyQueries : IStgDataBridgesFyQueries
    {
        public string AddQuery() => @"
            INSERT INTO b4.stg_data_bridges_fy
        ...
        public string GetByIdQuery() => "SELECT * FROM b4.stg_data_bridges_fy WHERE id = @Id";

        public string GetAllQuery() => "SELECT * FROM b4.stg_data_bridges_fy LIMIT 2000";

        public string UpdateQuery() => @"
            UPDATE b4.stg_data_bridges_fy SET
        ...
        public string DeleteQuery() => "DELETE FROM b4.stg_data_bridges_fy WHERE id = @Id";

        public string GetByPlantaEjercicioQuery() => @"
            SELECT * FROM b4.stg_data_bridges_fy
