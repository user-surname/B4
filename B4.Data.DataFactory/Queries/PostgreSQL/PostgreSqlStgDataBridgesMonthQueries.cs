...
{
    public sealed class PostgreSqlStgDataBridgesMonthQueries : IStgDataBridgesMonthQueries
    {
        public string AddQuery() => @"
            INSERT INTO b4.stg_data_bridges_month
        ...
        public string GetByIdQuery() => "SELECT * FROM b4.stg_data_bridges_month WHERE id = @Id";

        public string GetAllQuery() => "SELECT * FROM b4.stg_data_bridges_month LIMIT 2000";

        public string UpdateQuery() => @"
            UPDATE b4.stg_data_bridges_month SET
        ...
        public string DeleteQuery() => "DELETE FROM b4.stg_data_bridges_month WHERE id = @Id";

        public string GetByPlantaEjercicioQuery() => @"
            SELECT * FROM b4.stg_data_bridges_month
