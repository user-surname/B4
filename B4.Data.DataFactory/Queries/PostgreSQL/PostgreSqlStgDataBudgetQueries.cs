...
{
    public sealed class PostgreSqlStgDataBudgetQueries : IStgDataBudgetQueries
    {
        public string AddQuery() => @"
            INSERT INTO b4.stg_data_budget
        ...
        public string GetByIdQuery() => "SELECT * FROM b4.stg_data_budget WHERE id = @Id";

        public string GetAllQuery() => "SELECT * FROM b4.stg_data_budget LIMIT 2000";

        public string UpdateQuery() => @"
            UPDATE b4.stg_data_budget SET
        ...
        public string DeleteQuery() => "DELETE FROM b4.stg_data_budget WHERE id = @Id";

        public string GetByPlantaEjercicioQuery() => @"
            SELECT * FROM b4.stg_data_budget
