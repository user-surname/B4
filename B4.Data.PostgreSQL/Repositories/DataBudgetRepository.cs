...
namespace B4.Data.PostgreSQL.Repositories
{
    public class DataBudgetRepository : IDataBudgetRepository
    {
        ...
        private const string _table = "b4.data_budget";

        public DataBudgetRepository(string connectionString)
        {
        ...
        public async Task UpdateAsync(DataBudget entity)
        {
            ...
            if (rows == 0)
                throw new Exception($"No existe registro en data_budget con id {entity.Id}");
        }
        ...
        public async Task DeleteAsync(int id)
        {
            ...
            if (rows == 0)
                throw new Exception($"No existe registro en data_budget con id {id}");
        }
    }
}
