...
namespace B4.Models.Entities
{
    public class DataActualsBw : DataForecastBw
    {
        ...
        public DataActualsBw(int id, int idAPICarga, string guidCarga, DateTime fechaUltModif, int idCompany, int ejercicio,
            ...
            : base(id, idAPICarga, guidCarga, fechaUltModif, idCompany, ejercicio, idCiclo, idFase, idCurrency, idEpigrafe,
